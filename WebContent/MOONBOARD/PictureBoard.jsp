  ...
  <table class="table table-hover">
	...
	<c:otherwise>
		...
		<tr align="center">
			...
			<td align="left">
				<a href="./freeview.board?idx=${row.idx }">${row.title }</a>
				<c:if test="${not empty row.sfile }">
						<a href="./freeview.board?boardtype=picture&idx=${row.idx }">
						<img src="../Uploads/${row.sfile }" style="width : 20px;"><br />
						</a>
				</c:if>
			</td>
			...
			<c:if test="${not empty row.ofile }">
				<a href="../moonboard/freedown.board?ofile=${row.ofile
	...
	<table class="table">
		<tr>
			...
			<td width="100" align="center"><button type="button"
				class="btn btn-light" onclick="location.href='./freewrite.board';">글쓰기</button></td>
		</tr>
	</table>
    </tbody>
  </table>
